...
COMMANDS = OrderedDict([('main', OrderedDict([('PWR', {'values': OrderedDict([('00', {'name': ('standby',
 ...
 ('hdmi-cec', OrderedDict([('CTV', {'values': OrderedDict([('POWER', {'name': 'power',
     'description': 'Power command'}),
    ('PWRON', {'name': 'on', 'description': 'Power On command'}),
    ('PWROFF', {'name': ('standby', 'off'),
     'description': 'Power Off / Standby command'}),
    ('CHUP', {'name': 'chup', 'description': 'Channel Up command'}),
    ('CHDN', {'name': 'chdn', 'description': 'Channel Down command'}),
    ('VLUP', {'name': 'vlup', 'description': 'Volume Up command'}),
    ('VLDN', {'name': 'vldn', 'description': 'Volume Down command'}),
    ('MUTE', {'name': 'mute', 'description': 'Mute command'}),
    ('DISP', {'name': 'disp', 'description': 'Display command'}),
    ...
    ('CLEAR', {'name': 'clear', 'description': 'Clear command'}),
    ('SETUP', {'name': 'setup', 'description': 'Setup command'}),
    ('GUIDE', {'name': 'guide', 'description': 'Guide command'}),
    ('PREV', {'name': 'prev', 'description': 'Previous command'}),
    ('UP', {'name': 'up', 'description': 'Up command'}),
    ('DOWN', {'name': 'down', 'description': 'Down command'}),
    ('LEFT', {'name': 'left', 'description': 'Left command'}),
    ('RIGHT', {'name': 'right', 'description': 'Right command'}),
    ('ENTER', {'name': 'enter', 'description': 'Enter command'}),
    ('RETURN', {'name': 'return', 'description': 'Return command'}),
    ('A', {'name': 'a', 'description': 'A command'}),
    ('B', {'name': 'b', 'description': 'B command'}),
    ('C', {'name': 'c', 'description': 'C command'}),
    ('D', {'name': 'd', 'description': 'D command'})]),
   'name': 'ctv',
   'description': 'HDMI CEC commands for TV'}),
  ('CDV', {'values': OrderedDict([('POWER', {'name': 'power',
     'description': 'Power command'}),
    ('PWRON', {'name': 'on', 'description': 'Power On command'}),
    ('PWROFF', {'name': ('standby', 'off'),
     'description': 'Power Off / Standby command'}),
    ('PLAY', {'name': 'play', 'description': 'Play command'}),
    ('STOP', {'name': 'stop', 'description': 'Stop command'}),
    ('SKIP.F', {'name': 'next', 'description': 'Next Track command'}),
    ('SKIP.R', {'name': 'prev', 'description': 'Previous Track command'}),
    ('FF', {'name': ('ff', 'fast-forward'),
     'description': 'Fast Forward command'}),
    ('REW', {'name': ('rew', 'rewind'), 'description': 'Rewind command'}),
    ('PAUSE', {'name': 'pause', 'description': 'Pause command'}),
    ('SETUP', {'name': 'setup', 'description': 'Setup command'}),
    ('TOPMENU', {'name': 'topmenu', 'description': 'Top Menu command'}),
    ('MENU', {'name': 'menu', 'description': 'Menu command'}),
    ('UP', {'name': 'up', 'description': 'Up command'}),
    ('DOWN', {'name': 'down', 'description': 'Down command'}),
    ('LEFT', {'name': 'left', 'description': 'Left command'}),
    ('RIGHT', {'name': 'right', 'description': 'Right command'}),
    ('ENTER', {'name': 'enter', 'description': 'Enter command'}),
    ('RETURN', {'name': 'return', 'description': 'Return command'}),
    ('OP/CL', {'name': ('open', 'close', 'op/cl', 'open/close'),
     'description': 'Open/Close Tray command'}),
    ('ANGLE', {'name': 'angle', 'description': 'Angle command'}),
    ('1', {'name': '1', 'description': '1 command'}),
    ('2', {'name': '2', 'description': '2 command'}),
    ('3', {'name': '3', 'description': '3 command'}),
    ('4', {'name': '4', 'description': '4 command'}),
    ...
    ('D', {'name': 'd', 'description': 'D command'})]),
   'name': 'cdv',
   'description': 'HDMI CEC commands for DVD/BD Player'})]))])

ZONE_MAPPINGS = {'': 'main', None: 'main'}

COMMAND_MAPPINGS = {'hdmi-cec': {'ctv': 'CTV', 'cdv': 'CDV'},
...
VALUE_MAPPINGS = {'hdmi-cec': {'CTV': {'vldn': 'VLDN',
   'disp': 'DISP',
   'right': 'RIGHT',
   'mute': 'MUTE',
   'down': 'DOWN',
 ...
 'zone3': {'PW3': {'standby': '00', 'on': '01', 'query': 'QSTN'},
  'TN3': {'treble-up': 'TUP',
   'bass-up': 'BUP',
   'bass-down': 'BDOWN',
   'treble-down': 'TDOWN',
 ...
 'main': {'HBL': {'auto': '00', 'analog': '01', 'query': 'QSTN'},
  ...
  'TCL': {'query': 'QSTN'},
  'HPR': {ValueRange(1, 8): (1, 8), 'query': 'QSTN'},
